...
public class SpelProcessor implements ItemProcessor<Map<String, Object>, Map<String, Object>> {
	...
	public SpelProcessor(StatefulConnection<String, String> connection, DateFormat dateFormat,
			Map<String, String> variables, Map<String, String> fields) {
		...
		context.setVariable("redis",
				connection instanceof StatefulRedisClusterConnection
						? ((StatefulRedisClusterConnection<String, String>) connection).sync()
