...
Redis Input/Output Tool (RIOT) is a data import/export tool for Redis that connects to various sources and targets: Redis, RediSearch, files, databases, and data generators.
