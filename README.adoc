...
[source,shell]
----
riot --host=redis-12000.redislabs.com --port=12000 --pool=96 --batch=500 --threads=96 gen --type=simple --max=100000000 --field value=100 redis --type=string --format=raw --keyspace=string --keys=index --field=value
----
...
[source,shell]
----
riot --host=redis-12000.redislabs.com --port=12000 --pool=96 --batch=500 --threads=96 gen --type=simple --max=100000000 redis --type=stream --keyspace=stream --keys=partition
----
