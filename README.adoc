...
image:https://codecov.io/gh/Redislabs-Solution-Architects/riot/branch/master/graph/badge.svg["Codecov", link="https://codecov.io/gh/Redislabs-Solution-Architects/riot"]
image:https://img.shields.io/lgtm/grade/java/g/Redislabs-Solution-Architects/riot.svg?logo=lgtm&logoWidth=18["Language grade: Java", link="https://lgtm.com/projects/g/Redislabs-Solution-Architects/riot/context:java"]
