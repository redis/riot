...
* Standalone: `redis :// [password@] host [: port] [/ database][? [timeout=timeout[d|h|m|s|ms|us|ns]] [&_database=database_]]`

* Standalone (SSL): `rediss :// [password@] host [: port] [/ database][? [timeout=timeout[d|h|m|s|ms|us|ns]] [&_database=database_]]`

* Standalone (Unix Domain Sockets): `redis-socket :// [password@]path [?[timeout=timeout[d|h|m|s|ms|us|ns]][&_database=database_]]`

* Sentinel: `redis-sentinel :// [password@] host1[: port1] [, host2[: port2]] [, hostN[: portN]] [/ database][?[timeout=timeout[d|h|m|s|ms|us|ns]] [&_sentinelMasterId=sentinelMasterId_] [&_database=database_]]`
+
