...
[source,shell]
----
riot faker --max 100 --field id=index --field firstName=name.firstName --field lastName=name.lastName --field address=address.fullAddress redis --keyspace person --keys id
----
[source,plaintext]
----
> HGETALL person:1
