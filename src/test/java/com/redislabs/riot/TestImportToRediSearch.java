...
public class TestImportToRediSearch extends BaseTest {
	...
	public void importBeers() throws Exception {
		...
		run("import csv --header --include 1 3 4 5 6 --url https://raw.githubusercontent.com/nickhould/craft-beers-dataset/master/data/processed/beers.csv search --index beerIdx --keys id");
