...
public class TestFile extends BaseTest {
    ...
    @Test
    public void testExportDataStructuresToJson() throws Exception {
        ...
        runCommand("export file /tmp/datastructures.json");
    ...
    @SuppressWarnings("rawtypes")
    @Test
    public void testExportJsonGz() throws Exception {
        File file = new File("/tmp/beers.json.gz");
        file.delete();
        runFile("import-json-hash");
        runFile("export-json-gz");
        JsonItemReaderBuilder<Map> builder = new JsonItemReaderBuilder<>();
        builder.name("json-file-reader");
