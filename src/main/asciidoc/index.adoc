...
Here is an excerpt of https://raw.githubusercontent.com/nickhould/craft-beers-dataset/master/data/processed/beers.csv[beers.csv]
[source,csv]
----
...
[source,shell]
----
$ riot import --keyspace employee --keys emp_no db --sql "select * from employees" --url "jdbc:mysql://localhost:3306/employees?serverTimezone=PST&useLegacyDatetimeCode=false&useSSL=false" --username root --password
----
...
[source,shell]
----
$ riot export --keyspace beer --keys id db --sql "INSERT INTO beers (id, name, style_name) VALUES (:id, :name, :style_name)" --url "jdbc:mysql://localhost:3306/employees?serverTimezone=PST&useLegacyDatetimeCode=false&useSSL=false" --username root --password
----
...
[source,shell]
----
riot import --max 100000000 --batch 500 --threads 96 --host redis-12000.redislabs.com --port 12000 --max-total 96 -c set --string-format raw --keyspace string --keys=index --value value simple value=100
----
...
[source,shell]
----
riot import --max 100000000 --batch 500 --threads 96 --host redis-12000.redislabs.com --port 12000 --pool 96 -c xadd --keyspace stream --keys partition simple
----
