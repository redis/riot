...
public class SpelProcessor implements ItemProcessor<Map<String, Object>, Map<String, Object>> {
    ...
    @Builder
    private SpelProcessor(StatefulConnection<String, String> connection, Function<StatefulConnection<String, String>, BaseRedisCommands<String, String>> commands, DateFormat dateFormat, Map<String, String> variables, Map<String, String> fields) {
