...
public class JedisMapReader extends AbstractItemCountingItemStreamItemReader<Map<String, Object>> {
	...
	public JedisMapReader(Pool<Jedis> jedisPool) {
		setName(ClassUtils.getShortName(JedisMapReader.class));
