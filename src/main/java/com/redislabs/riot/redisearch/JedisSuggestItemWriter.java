...
public class JedisSuggestItemWriter extends AbstractItemStreamItemWriter<Map<String, Object>> {
	...
	public JedisSuggestItemWriter(Client client, RedisConverter converter) {
		setName(ClassUtils.getShortName(JedisSuggestItemWriter.class));
		this.client = client;
