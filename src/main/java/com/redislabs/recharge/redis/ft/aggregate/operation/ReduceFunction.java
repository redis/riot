...
import com.redislabs.recharge.redis.ft.aggregate.operation.reduce.FirstValue;
import com.redislabs.recharge.redis.ft.aggregate.operation.reduce.PropertyReducer;
import com.redislabs.recharge.redis.ft.aggregate.operation.reduce.Quantile;
import com.redislabs.recharge.redis.ft.aggregate.operation.reduce.RandomSample;
import com.redislabs.recharge.redis.ft.aggregate.operation.reduce.Reducer;
