...
[source,shell]
----
include::file/src/test/resources/import-csv-hash.txt[]
----

.Import CSV into RediSearch index
[source,shell]
----
include::file/src/test/resources/import-csv-search.txt[]
----
...
[source,shell]
----
include::file/src/test/resources/import-csv-geo.txt[]
----

.Import CSV into RediSearch geo
[source,shell]
----
include::file/src/test/resources/import-csv-processor-search-geo.txt[]
----

.Export to CSV
[source,shell]
----
include::file/src/test/resources/export-csv.txt[]
----
...
[source,shell]
----
include::file/src/test/resources/import-json-hash.txt[]
----

.Export JSON
[source,shell]
----
include::file/src/test/resources/export-json.txt[]
----

.Export compressed JSON
[source,shell]
----
include::file/src/test/resources/export-json-gz.txt[]
----
...
[source,shell]
----
include::db/src/test/resources/import.txt[]
----

.Export to a database
[source,shell]
----
include::db/src/test/resources/export.txt[]
----

[#gen]
=== Data Generator

*riot-gen* generates random data using the https://github.com/DiUS/java-faker[Faker] library.
...
[source,shell]
----
include::gen/src/test/resources/import-hash.txt[]
----

.Faker Sets
[source,shell]
----
include::gen/src/test/resources/import-set.txt[]
----

.RediSearch index introspection
[source,shell]
----
include::gen/src/test/resources/index-introspection.txt[]
----

[#redis]
=== Redis

*redis-db* allows for replicating data between two Redis databases using scan and optionally keyspace notifications (*live* replication).

.Live replication from `localhost:6379` to `localhost:6380`
[source,shell]
----
include::redis/src/test/resources/replicate-live.txt[]
----
...
[source,shell]
----
include::file/src/test/resources/import-csv-processor-hash-dateformat.txt[]
----
...
[source,shell]
----
❯ riot-gen -r redis://redis-12001.redislabs.com:12001 --pool 96 import --metadata --batch 5000 --threads 96 --max 100000000 --command set --keyspace test --keys index --value index
----
...
[source,shell]
----
❯ riot-gen -r redis://redis-12001.redislabs.com:12001 --pool 96 import "partition=number.randomDigit" --metadata --batch 5000 --threads 96 --max 100000000 --command xadd --keyspace stream --keys partition
----
