...
public abstract class AbstractResourceItemWriter<T> extends AbstractItemStreamItemWriter<T>
    ...
    protected final Logger log = LoggerFactory.getLogger(AbstractResourceItemWriter.class);
    ...
    public void write(List<? extends T> items) throws Exception {
        ...
        log.debug("Writing to file with {} items.", items.size());
    ...
    protected class OutputState {
        ...
        private static final String ERROR_CLOSING = "Unable to close the the ItemWriter";
        ...
        public void close() {
            ...
            try {
                ...
                throw new ItemStreamException(ERROR_CLOSING, ioe);
            } finally {
                if (!transactional) {
                    closeStream();
                }
