...
{project-title} processes data in batch fashion, i.e. a fixed number of records (batch AKA chunk) is read, processed, and written at a time. Then it'll repeat the cycle until there's no more data on the source.
