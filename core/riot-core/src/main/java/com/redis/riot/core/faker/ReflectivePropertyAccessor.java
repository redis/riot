...
public class ReflectivePropertyAccessor implements PropertyAccessor {
    ...
    public void write(EvaluationContext context, @Nullable Object target, String name, @Nullable Object newValue)
        ...
        if (!this.allowWrite) {
            throw new AccessException(
                    "PropertyAccessor for property '" + name + "' on target [" + target + "] does not allow write operations");
        }
     ...
     * <p>
     * The default implementation considers any method as a candidate, even for non-user-declared properties on the
    ...
    /**
     * Attempt to create an optimized property accessor tailored for a property of a particular name on a particular class. The
     * general ReflectivePropertyAccessor will always work but is not optimal due to the need to lookup which reflective member
     * (method/field) to use each time read() is called. This method will just return the ReflectivePropertyAccessor instance if
     * it is unable to build a more optimal accessor.
     * <p>
     * Note: An optimal accessor is currently only usable for read attempts. Do not call this method if you need a read-write
     * accessor.
     *
    ...
    /**
     * Captures the member (method/field) to call reflectively to access a property value and the type descriptor for the value
     * returned by the reflective call.
     */
    ...
    /**
     * An optimized form of a PropertyAccessor that will use reflection but only knows how to access a particular property on a
     * particular class. This is unlike the general ReflectivePropertyResolver which manages a cache of methods/fields that may
     * be invoked to access different properties on different classes. This optimal accessor exists because looking up the
