...
public class RedisOptions {
    ...
    @Option(names = {"-o", "--timeout"}, description = "Redis command timeout (default: ${DEFAULT-VALUE})", paramLabel = "<sec>")
    ...
    @Option(names = {"-m", "--pool"}, description = "Max pool connections (default: ${DEFAULT-VALUE})", paramLabel = "<int>")
    ...
    public RedisClient redisClient() {
        ...
        client.setOptions(ClientOptions.builder().autoReconnect(!noAutoReconnect).sslOptions(sslOptions()).build());
        return client;
    }

    public RedisClusterClient redisClusterClient() {
        RedisClusterClient client = RedisClusterClient.create(clientResources(), uri());
        client.setOptions(ClusterClientOptions.builder().autoReconnect(!noAutoReconnect).sslOptions(sslOptions()).build());
        return client;
    }
