...
[subs=+quotes]
----
[green]#riot-db# -h <redis host> -p <redis port> import --url <jdbc url> [yellow]#SQL# [REDIS COMMAND...]
----
...
[subs=+quotes]
----
[green]#riot-db# -h <redis host> -p <redis port> export --url <jdbc url> [yellow]#SQL#
----
