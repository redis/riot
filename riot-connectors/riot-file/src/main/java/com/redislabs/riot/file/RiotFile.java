...
@CommandLine.Command(name = "riot-file", subcommands = { MapFileImportCommand.class, RedisFileImportCommand.class,
		MapFileExportCommand.class, RedisFileExportCommand.class })
