...
import com.redis.riot.core.convert.MapToStringArrayConverter;
...
public class EvalCommand extends AbstractOperationCommand<Map<String, Object>> {
	...
	private Function<Map<String, Object>, String[]> converter(String[] fields) {
		if (ObjectUtils.isEmpty(fields)) {
			return m -> EMPTY_STRING;
		}
		Function<Map<String, Object>, String>[] extractors = new Function[fields.length];
